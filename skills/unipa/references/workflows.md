...
- For notices, prefer the visible list plus the specific detail page for the requested notice. Summarize source date, title, sender/department, and action needed.
...
- If the session expires, ask the user to log in again or authorize using saved autofill.
